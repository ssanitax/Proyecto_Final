...
class Coleccion {
    ...
    public function agregarEdicion(
        ...
        $valoracion_personal = null,
        $idioma_id = null,
        $region = null
    ) {
        $sql = "INSERT INTO coleccion_usuario (usuario_id, edicion_id, idioma_id, region, estado_conservacion, valoracion_personal) 
                VALUES (:usuario_id, :edicion_id, :idioma_id, :region, :estado_conservacion, :valoracion_personal)";
