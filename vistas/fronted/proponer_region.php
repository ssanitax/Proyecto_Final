...
<div class="fade-up visible" style="max-width: 600px; margin: 0 auto;">
    <header style="text-align: center; margin-bottom: 30px;">
        <h2>Sugerir Nueva Región</h2>
        <p style="color: #666;">Añade variantes geográficas para las ediciones físicas.</p>
    </header>
    ...
    <div class="about-box" style="padding: 40px; background: white; border-radius: 20px; border: 1px solid #eee;">
        <form action="../../controllers/JuegoController.php?action=sugerir_region_independiente" method="POST">
            <div class="form-group" style="margin-bottom: 25px; text-align: left;">
                <label style="font-weight: 800; font-size: 0.8rem; display: block; margin-bottom: 10px;">NOMBRE DE LA REGIÓN / CÓDIGO</label>
                <input type="text" name="nombre_region" placeholder="Ej: NTSC-J (Asia), PAL-Australia..." required 
